<header class="clearfix" ng-controller="LoginContrasenaCrtl"> 
          ...
          <div class="col-md-12 text-center">
            ...
            <div class="col-md-4">
              <div class="logi-box">
                ...
                <form id="recuperar-pass" name="User_Pass">
                <input type="hidden" name="_csrf">
                    <div class="form-group">
                    <div class="controls">
                      <label>Contrase&ntilde;a Nueva</label>    
                      <div class="form-group field-formrecoverpass-username required">

                          <input type="password" id="user-pass-new" class="email password" name="user_email" ng-model="data.user_pass" placeholder="................" required>
...
<div class="help-block"></div>
                   ...
                   <label>Confirme Contrase&ntilde;a </label>    
                      <div class="form-group field-formrecoverpass-username required">
                          ...
                          <input type="password" id="user-pass-conf" class="email password" name="user_confpass" ng-model="data.user_confpass" placeholder="............" required>

<div class="help-block"></div>
</div>   
                    </div>
                  </div>
                  <button type="submit" ng-disabled="!User_Pass.$valid" id="submit" ng-click="restablecer()"class="btn-system01">RECUPERAR CONTRASE&Ntilde;A</button>
                </form>
              </div>
