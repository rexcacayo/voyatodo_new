...
<input type="email" id="user-pass" class="email requiredField" name="user_email" ng-model="data.user_email" placeholder="johnsmith@mymail.com">

<div class="help-block"></div>
</div>                    </div>
                  </div>
                  <button type="submit" id="submit" class="btn-system01" ng-click="cambiar()">CAMBIAR CONTRASE&Ntilde;A</button>
                </form>
              </div>
