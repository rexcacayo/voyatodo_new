...
;jQuery('#formcreateevent-event_stardate').parent().datepicker({"autoclose":true,"format":"dd-mm-yyyy","language":"es"});
;jQuery('#formcreateevent-event_enddate').parent().datepicker({"autoclose":true,"format":"dd-mm-yyyy","language":"es"});
jQuery('#mail-form').yiiActiveForm([{"id":"mailsend-subject","name":"subject","container":".field-mailsend-subject","input":"#mailsend-subject","enableAjaxValidation":true,"validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Complete este campo"});yii.validation.regularExpression(value, messages, {"pattern":/^.{1,140}$/,"not":false,"message":"Máximo 140 caracteres","skipOnEmpty":1});}},{"id":"mailsend-message","name":"message","container":".field-mailsend-message","input":"#mailsend-message","enableAjaxValidation":true,"validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Complete este campo"});}},{"id":"mailsend-response","name":"response","container":".field-mailsend-response","input":"#mailsend-response","enableAjaxValidation":true,"validate":function (attribute, value, messages, deferred, $form) {yii.validation.email(value, messages, {"pattern":/^[a-zA-Z0-9!#$%&'*+\/=?^_`{|}~-]+(?:\.[a-zA-Z0-9!#$%&'*+\/=?^_`{|}~-]+)*@(?:[a-zA-Z0-9](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?\.)+[a-zA-Z0-9](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?$/,"fullPattern":/^[^@]*<[a-zA-Z0-9!#$%&'*+\/=?^_`{|}~-]+(?:\.[a-zA-Z0-9!#$%&'*+\/=?^_`{|}~-]+)*@(?:[a-zA-Z0-9](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?\.)+[a-zA-Z0-9](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?>$/,"allowName":false,"message":"El correo ingresado no tiene un formato valido","enableIDN":false,"skipOnEmpty":1});}}], []);
;jQuery('#formcreateevent-ticket_enddate').parent().datepicker({"autoclose":true,"format":"mm-dd-yyyy","language":"es"});
;jQuery('#formcreateevent-ticket_start').parent().datepicker({"autoclose":true,"format":"yyyy-mm-dd","language":"es"});
;jQuery('#formcreateevent-ticket_finish').parent().datepicker({"autoclose":true,"format":"yyyy-mm-dd","language":"es"});
jQuery('#form-create').yiiActiveForm([{"id":"formcreateevent-event_name","name":"event_name","container":".field-formcreateevent-event_name","input":"#formcreateevent-event_name","enableAjaxValidation":true,"validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Campo requerido"});yii.validation.regularExpression(value, messages, {"pattern":/^.{5,80}$/,"not":false,"message":"Mínimo 5 y máximo 80 caracteres","skipOnEmpty":1});}},{"id":"formcreateevent-event_stardate","name":"event_stardate","container":".field-formcreateevent-event_stardate","input":"#formcreateevent-event_stardate","enableAjaxValidation":true,"validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Campo requerido"});}},{"id":"formcreateevent-event_starthour","name":"event_starthour","container":".field-formcreateevent-event_starthour","input":"#formcreateevent-event_starthour","enableAjaxValidation":true,"validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Campo requerido"});}},{"id":"formcreateevent-event_enddate","name":"event_enddate","container":".field-formcreateevent-event_enddate","input":"#formcreateevent-event_enddate","enableAjaxValidation":true,"validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Campo requerido"});}},{"id":"formcreateevent-event_endhour","name":"event_endhour","container":".field-formcreateevent-event_endhour","input":"#formcreateevent-event_endhour","enableAjaxValidation":true,"validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Campo requerido"});}},{"id":"formcreateevent-event_country","name":"event_country","container":".field-formcreateevent-event_country","input":"#formcreateevent-event_country","enableAjaxValidation":true,"validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Campo requerido"});}},{"id":"formcreateevent-event_city","name":"event_city","container":".field-formcreateevent-event_city","input":"#formcreateevent-event_city","enableAjaxValidation":true,"validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Campo requerido"});}},{"id":"formcreateevent-event_place","name":"event_place","container":".field-formcreateevent-event_place","input":"#formcreateevent-event_place","enableAjaxValidation":true,"validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Campo requerido"});}},{"id":"formcreateevent-event_address","name":"event_address","container":".field-formcreateevent-event_address","input":"#formcreateevent-event_address","enableAjaxValidation":true,"validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Campo requerido"});}},{"id":"formcreateevent-event_category_principal","name":"event_category_principal","container":".field-formcreateevent-event_category_principal","input":"#formcreateevent-event_category_principal","enableAjaxValidation":true,"validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Campo requerido"});}},{"id":"formcreateevent-event_category_secundary","name":"event_category_secundary","container":".field-formcreateevent-event_category_secundary","input":"#formcreateevent-event_category_secundary","enableAjaxValidation":true,"validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Campo requerido"});}},{"id":"formcreateevent-event_review","name":"event_review","container":".field-formcreateevent-event_review","input":"#formcreateevent-event_review","enableAjaxValidation":true,"validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Campo requerido"});yii.validation.regularExpression(value, messages, {"pattern":/^.{5,140}$/,"not":false,"message":"Mínimo 5 y máximo 140 caracteres","skipOnEmpty":1});}},{"id":"formcreateevent-event_description","name":"event_description","container":".field-formcreateevent-event_description","input":"#formcreateevent-event_description","enableAjaxValidation":true,"validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Campo requerido"});yii.validation.regularExpression(value, messages, {"pattern":/^.{10,400}$/,"not":false,"message":"Mínimo 10 y máximo 400 caracteres","skipOnEmpty":1});}},{"id":"formcreateevent-event_crowfunding","name":"event_crowfunding","container":".field-formcreateevent-event_crowfunding","input":"#formcreateevent-event_crowfunding","enableAjaxValidation":true,"validate":function (attribute, value, messages, deferred, $form) {yii.validation.regularExpression(value, messages, {"pattern":/^[0-9]*$/i,"not":false,"message":"Sólo se aceptan números","skipOnEmpty":1});}},{"id":"formcreateevent-event_url","name":"event_url","container":".field-formcreateevent-event_url","input":"#formcreateevent-event_url","enableAjaxValidation":true,"validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Campo requerido"});}},{"id":"formcreateevent-event_linkvideo","name":"event_linkvideo","container":".field-formcreateevent-event_linkvideo","input":"#formcreateevent-event_linkvideo","enableAjaxValidation":true,"validate":function (attribute, value, messages, deferred, $form) {yii.validation.string(value, messages, {"message":"Máximo 255 caracteres","max":255,"tooLong":"Event Linkvideo should contain at most 255 characters.","skipOnEmpty":1});}},{"id":"formcreateevent-event_galery","name":"event_galery[]","container":".field-formcreateevent-event_galery","input":"#formcreateevent-event_galery","enableAjaxValidation":true,"validate":function (attribute, value, messages, deferred, $form) {yii.validation.file(attribute, messages, {"message":"File upload failed.","skipOnEmpty":true,"mimeTypes":[],"wrongMimeType":"Only files with these MIME types are allowed: .","extensions":["png","jpg","jpeg"],"wrongExtension":"El archivo {file} no contiene una extensión permitida png, jpg, jpeg","maxSize":2097152,"tooBig":"El tamaño máximo permitido es 2MB","maxFiles":3,"tooMany":""});}},{"id":"formcreateevent-event_terms","name":"event_terms","container":".field-formcreateevent-event_terms","input":"#formcreateevent-event_terms","enableAjaxValidation":true,"validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Campo requerido"});}},{"id":"formcreateevent-event_visible","name":"event_visible","container":".field-formcreateevent-event_visible","input":"#formcreateevent-event_visible","enableAjaxValidation":true,"validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Campo requerido"});}}], []);
});</script>
-->
