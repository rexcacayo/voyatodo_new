<!doctype html>
<header class="clearfix" ng-controller="CompradorProductoCrtl"> 
      ...
      <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse mn"> 
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="javasciprt:void(0)">Mis entradas</a></li>
      ...
      <div class="item active"> <img class="img-responsive02" src="tema/images/inner-banner01.jpg" alt="slider">
        <div class="slider-content">
          <div class="col-md-12 text-center">
            ...
            <p class="animated4" style="margin-top: 10px;"><a href="" class="eventos public" >BUSCAR EVENTO</a></p>
          </div>
        </div>
      </div>
    </div>
