...
$(document).on('change',".type_user",function(){
	...
	$(".user_type").val(type);
	if(type == 1){
		$(".opt_people").removeClass("hidden");
		$(".opt_company").addClass("hidden");
	}
	else{
		$(".opt_people").addClass("hidden");
		$(".opt_company").removeClass("hidden");
	}
});
...
$(document).on('click',".icon_share",function(){
  	var name1 = $(this).attr('data-id');
  	var url = $(this).attr('data-url');
  	$(".icon_share").each(function(){
    	var name = $(this).attr('data-id');
    	$('.icon_share'+name).css('background','url('+baseurl+'images/icon-share-gray.gif) center no-repeat');
  	});
  	$(".icon_share"+name1).css('background','url('+baseurl+'images/icon-share-blue.png) center no-repeat');
  	$(".icon_share_facebook").attr('href','http://www.facebook.com/sharer.php?u='+url);
  	$(".icon_share_twitter").attr('href','https://twitter.com/share'+url);
  	$(".icon_share_linkedin").attr('href','https://www.linkedin.com/cws/share?url='+url);
  	$(".icon_share_google").attr('href','https://plus.google.com/share?url='+url);
});

$(document).on('click',".share_google_2",function(){
	window.open($(this).attr('data-url'),'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');
	return false;
});

$(document).on('click',".share_twitter_2",function(){
	window.open($(this).attr('data-url'),'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=500,width=600');
	return false;
});

$(document).on('click',".share_linkedin_2",function(){
	window.open($(this).attr('data-url'),'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=400,width=600');
	return false;
});
$(document).on('click',".share_facebook_2",function(){
	window.open($(this).attr('data-url'),'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=500,width=500');
	return false;
});